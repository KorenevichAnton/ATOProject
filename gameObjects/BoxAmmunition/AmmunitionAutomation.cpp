...
//---------------------------------------------------------------------------------------------------------------------------------
AmmunitionAutomation::AmmunitionAutomation()
{
...
//---------------------------------------------------------------------------------------------------------------------------------
bool AmmunitionAutomation::init()
{
...
//---------------------------------------------------------------------------------------------------------------------------------
AmmunitionAutomation* AmmunitionAutomation::create(int _countAmmo)
{
	AmmunitionAutomation *pRet = new AmmunitionAutomation();
...
//---------------------------------------------------------------------------------------------------------------------------------
void AmmunitionAutomation::increaseAmmo()
{
